    ...
    <>
      <motion.header
        ...
        animate={{
          ...
          boxShadow: scrolled ? "0 1px 0 rgba(0,0,0,0.06), 0 8px 24px rgba(0,0,0,0.04)" : "0 0 0 rgba(0,0,0,0)",
        }}
        transition={{ duration: 0.3 }}
        className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md"
      >
        <div className="max-w-7xl mx-auto px-5 lg:px-8 h-[72px] flex items-center justify-between py-3">
          <Link href="/" className="flex items-center gap-2.5 shrink-0">
            <Image src="/focus-logo.png" alt="FOCUS Marketing" width={52} height={52} priority className="h-12 w-12 object-contain" />
            <div className="leading-none">
              <div className="text-[11px] text-foreground/45 font-semibold tracking-wide">Focus Marketing</div>
            </div>
          </Link>
